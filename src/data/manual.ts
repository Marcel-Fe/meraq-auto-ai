...
const HOTSPOT_KEYWORDS: Record<string, string[]> = {
  ...
  tire: ['reifen', 'profiltiefe', 'luftdruck', 'reifendruck', 'radsatz', 'radschraube'],
  ...
  battery: ['starterbatterie', 'autobatterie', 'bordnetzspannung', 'lichtmaschine', 'anlasser', 'starthilfe'],
